...
class LConv2d(torch.nn.Conv3d):
    ...
    def __init__(
        ...
        """Implements a 2d-convolution applied pointwise in time. See https://pytorch.org/docs/stable/generated/torch.nn.Conv2d.html?highlight=conv2d#torch.nn.Conv2d,
