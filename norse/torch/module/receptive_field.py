...
from norse.torch.functional.receptive_field import receptive_fields_with_derivatives
...
class SpatialReceptiveField2d(torch.nn.Module):
    def __init__(
        ...
        **kwargs
        ...
        """
        super().__init__()
        fields = receptive_fields_with_derivatives(n_scales, n_angles, n_ratios, size)
