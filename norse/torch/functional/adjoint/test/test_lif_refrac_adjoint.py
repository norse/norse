...
def test_lif_refrac_adjoint_step():
    ...
    for i in range(100):
        z, s = lif_refrac_adjoint_step(input, s, input_weights, recurrent_weights)
...
def test_lif_refrac_feed_forward_adjoint_step():
    ...
    for i in range(100):
        z, s = lif_refrac_feed_forward_adjoint_step(input, s)
...
def lif_refrac_adjoint_compatibility_test():
    ...
    for i in range(100):
        z0, s0 = lif_refrac_adjoint_step(input, s0, input_weights, recurrent_weights)
        z1, s1 = lif_refrac_step(input, s1, input_weights, recurrent_weights)
...
def test_lif_refrac_feed_forward_adjoint_compatibility():
    ...
    for i in range(100):
        z0, s0 = lif_refrac_feed_forward_adjoint_step(input, s0)
        z1, s1 = lif_refrac_feed_forward_step(input, s1)
