...
* [SpikingJelly](https://github.com/fangwei123456/spikingjelly) is another PyTorch-based spiking neural network simulator. SpikingJelly uses stateful neurons and [demonstrates performance similar to Norse on the MNIST dataset](https://github.com/fangwei123456/Parametric-Leaky-Integrate-and-Fire-Spiking-Neuron).
